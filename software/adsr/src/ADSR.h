...
//
//  1.01  2016-01-02  njr   added calcCoef to SetTargetRatio functions that
//                          were in the ADSR widget but missing in this code
//  1.02  2017-01-04  njr   in calcCoef, checked for rate 0, to support
//                          non-IEEE compliant compilers
//  1.03  2020-04-08  njr   changed float to double; large target ratio and
//                          rate resulted in exp returning 1 in calcCoef
//
